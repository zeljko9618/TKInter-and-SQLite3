...
from funktionen_template import template_suche
from funktionen_template import TreeviewWithMenu
from funktionen_template import Datenbank_Manager_S
from funktionen_template import Treeview_Füller_Template
from funktionen_template import MyTreeViewHandler_Template
...
#####################################################################################################################
        ...
        self.treeview_left_frame = ttk.Treeview(self.left_frame , columns=('Z_Nummer', 'BE_Text', 'Kostentraeger', 'KT_Text', 'Team_Name', 'Objekt_Name', 'Taetigkeit', 'OE'), show='headings')
        ...
        self.treeview_left_frame.heading('Z_Nummer', text='Z_Nummer')
        self.treeview_left_frame.heading('BE_Text', text='BE_Text')
        self.treeview_left_frame.heading('Kostentraeger', text='KT')
        self.treeview_left_frame.heading('KT_Text', text='KT_Text')
        ...
        self.treeview_left_frame.column('Z_Nummer', width=100)
        self.treeview_left_frame.column('BE_Text', width=150)
        self.treeview_left_frame.column('Kostentraeger', width=100)
        self.treeview_left_frame.column('KT_Text', width=150)
        ...
        # Tabs
        self.tree_guiN = ttk.Treeview(self.tab2, columns=("Berichtselement", "Berichtselement_Name", "Projektstart", "Projektende", "SOP", "Projektleiter", "Projektcontroller"), show='headings', selectmode="extended")
        self.tree_guiN.heading("Berichtselement", text="Berichtselement")
        self.tree_guiN.heading("Berichtselement_Name", text="Berichtselement_Name")
        self.tree_guiN.heading("Projektstart", text= "Projektstart")
        self.tree_guiN.heading("Projektende", text= "Projektende")
        self.tree_guiN.heading("SOP", text="SOP")
        self.tree_guiN.heading("Projektleiter", text= "Projektleiter")
        self.tree_guiN.heading("Projektcontroller", text= "Projektcontroller")        
        ...
        self.label_ID = tk.Label(self.right_frame, text="Berichtselement", font=("Audi Type", 15), fg='#BB0A30', pady=5, padx=5)   
        ...
        self.label_1 = tk.Label(self.right_frame, text="Berichtselement Name", font=("Audi Type", 15), fg='#BB0A30', pady=5, padx=5)                
        ...
        self.label_2 = tk.Label(self.right_frame, text="Kostenträger", font=("Audi Type", 15), fg='#BB0A30', pady=5, padx=5)
        ...
        self.label_3 = tk.Label(self.right_frame, text="Kostenträger Name", font=("Audi Type", 15), fg='#BB0A30', pady=5, padx=5)
        ...
        self.suchen_1 = tk.Button(self.right_frame, text="suchen", font=("Audi Type", 10), fg='#BB0A30', pady=10, padx=10, command=lambda: (template_suche.suchen(self,"Z_Nummer Like '%"+(str(self.eingabefeld_wert_ID.get()))+"%'" ),self.eingabefeld_ID.delete(0,tk.END)))
...
#########################################################################################################################
        ...
        # Treeview anzeigen
        treeview_actions = MyTreeViewHandler_Template(self.treeview_left_frame, self.tree, self.tree_guiN, self.tree_Teams)

        #handler = MyTreeViewHandler_felder_füllen(self.treeview_Projekt, self.eingabefeld_ID, self.eingabefeld_1, self.eingabefeld_2)
